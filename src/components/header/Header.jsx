...
import logo from '../../assets/images/logo/danitech-logo.svg'
                    ...
                    <div className="col-12">
                        <div className="header__body">
                            <div className="header__logo">
                                <Link to="/">
                                    <img id="site-logo" src={logo} alt='DaniTech' />
                                </Link>
                            </div>
                            ...
                            <div className="header__action">
                                ...
                                <Link to="/contact" className="action-btn"><span>TELL US</span></Link>
                            </div>
                        </div>
                    </div>
                </div>
