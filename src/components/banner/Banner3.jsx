                ...
                <div className="col-xl-5 col-md-12">
                    <div className="banner__left">
                        <div className="block-text">
                            <h2 className="heading">ZEHN AFZAR
                                SORENA<span className="arlo_tm_animation_text_word"></span>
                                </h2>
                            <p className="desc">zehn afzar is the premier marketplace for nifties, which are digital items you can truly own for yourself</p>
