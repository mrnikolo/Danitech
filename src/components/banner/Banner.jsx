                    ...
                    <div className="row">
                        <div className="col-xl-6 col-md-12">
                            <div className="banner__left">
                                <div className="block-text">
                                    <h2 className="heading">ZEHN AFZAR <br />
                                        OFFICIAL <span className="s1 arlo_tm_animation_text_word">SORENA</span> <br />
                                    QBIT</h2>
                                    <p className="desc">At ZEHN AFZAR we are not just developers; we are digital architects, problem solvers, and creators of cutting-edge solutions. Our passion for programming and technology drives us to push boundaries, transform ideas into reality, and deliver software that exceeds expectations.</p>

                                    <Link to="/contact" className="action-btn"><span>Get Connected</span></Link>
                                </div>

                                <div className="pay">
                                    <h6>We are QBIT NFT</h6>
                        ...
                        <div className="col-xl-6 col-md-12">
                            ...
                            <div className="banner__right">
                                <div className="image">
                                    <img src={img1} alt="ZehnAfzar" />
                                </div>

                                <div className="price">
                                    <div className="icon">
                                        <img src={img2} alt="ZehnAfzar" />
                                    </div>
